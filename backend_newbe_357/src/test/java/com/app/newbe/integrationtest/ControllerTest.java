package com.app.newbe.integrationtest;
...
import com.app.newbe.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("newbe", n.getAttribute("Namespace"));
  ...
  given()
   ...
   given()
            .when()
            .get("/newbe/PetCareCenters?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/newbe/PetCareCenters/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM newbe.PetService");
    jdbcTemplate.execute("DELETE FROM newbe.PetOwner");
    jdbcTemplate.execute("DELETE FROM newbe.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM newbe.Document");
    jdbcTemplate.execute("DELETE FROM newbe.Pet");
     jdbcTemplate.execute("DELETE FROM newbe.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM newbe.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM newbe.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM newbe.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM newbe.PetCareCenterPets");
